      ...
      <div className="container">
        ...
        <div className="advantage-employee__list">
          <div className="advantage-employee__item">
            ...
            <div className="advantage-employee__item-note">Your earning are available to you in seconds!</div>
          </div>
          <div className="advantage-employee__item">
            <div className="advantage-employee__item-ico">
            ...
            <div className="advantage-employee__item-note">Build your financial IQ & track your earning in real-time.</div>
          </div>
          <div className="advantage-employee__item">
            <div className="advantage-employee__item-ico">
            ...
            <div className="advantage-employee__item-note">Save & Grow your earning in real-time with us.</div>
          </div>
        </div>
      </div>
    </section>
